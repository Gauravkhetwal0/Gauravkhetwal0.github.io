  ...
  const getNextStatus = mole => {
    switch (mole.status) {
      ...
      case "fed":
        ...
        if (mole.king) {
          mole.node.children[0].src = "../img/moleGame/king-mole-leaving.png";
        } else {
          mole.node.children[0].src = "../img/moleGame/mole-leaving.png";
        }
        mole.status = "leaving";
        break;
      case "leaving":
      ...
      case "hungry":
        ...
        if (mole.king) {
          mole.node.children[0].src = "../img/moleGame/king-mole-sad.png";
        } else {
          mole.node.children[0].src = "../img/moleGame/mole-sad.png";
        }
        mole.status = "sad";
        mole.next = getSadInterval();
        break;
      case "gone":
        ...
        if (mole.king) {
          mole.node.children[0].src = "../img/moleGame/king-mole-hungry.png";
        } else {
          mole.node.children[0].src = "../img/moleGame/mole-hungry.png";
        }
        break;
    }
  };
...
const feed = e => {
  ...
  mole.node.children[0].classList.toggle("hungry", false);
  if (mole.king) {
    mole.node.children[0].src = "../img/moleGame/king-mole-fed.png";
    score += 20;
  } else {
    mole.node.children[0].src = "../img/moleGame/mole-fed.png";
    score += 10;
  }
